package edu.shenzen.maysam.algorithm;
...
public class SmartNSGAII<S extends Solution<?>> implements Algorithm<List<S>> {
     ...
     * Constructor
     */
    public SmartNSGAII(Problem<S> problem, int maxEvaluations, int populationSize,
    ...
    public void run() {
        ...
        while (evaluations < maxEvaluations) {
            ...
            //System.out.println("Iteration at : " + evaluations/population.size());
